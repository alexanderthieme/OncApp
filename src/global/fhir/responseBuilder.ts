...
export const buildQuestionnaireResponse = (
  ...
  // The answers that are stored by OncApp include nested answers i.e X0: ['2'].
  // These are only needed for some OncApp internal calculations and not for creating the FHIR response. So we filter them out.
